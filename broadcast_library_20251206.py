"""
Рассылка «Библиотека Mom's Club» от 06.12.2025: картинка + текст + кнопки.
Запуск: python3 broadcast_library_20251206.py [admins|all]
...
# Текст рассылки с HTML форматированием
BROADCAST_TEXT_HTML = (
    "<b>Mom's Club становится ещё сильнее</b> — мы запускаем новую <b>БИБЛИОТЕКУ Mom's Club</b> 📚✨\n\n"
    "Это <b>первое и единственное</b> сообщество мам-блогеров, у которого есть своё мини-приложение с материалами для роста в блоге 🤎\n\n"
    "<b>Что ты найдёшь внутри?</b>\n"
    "— 100+ полезных материалов: статей, подкастов и практик\n"
    "— разборы от экспертов\n"
    "— уроки по съёмке, монтажу и визуалу\n"
    "— вдохновляющие цитаты и все новости клуба\n\n"
    "<b>Как пользоваться:</b>\n"
    "📱 Открой библиотеку в браузере → нажми «Добавить на экран» → и она станет как приложение.\n"
    "И всё — материалы с тобой 24/7.\n\n"
    "Спасибо, что растёшь вместе с нами.\n"
    "Обнимаю, ваша Полина и команда Mom's Club 💕"
)
...
def build_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="📚 Открыть библиотеку", url="https://librarymomsclub.ru/library")],
    ...
    async with AsyncSessionLocal() as session:
        for tg_id in user_ids:
            ...
            try:
                ...
                sent += 1
                logger.info(f"Отправлено пользователю {tg_id}")
...
def _format_report(stats: dict, total: int, start: datetime, end: datetime) -> str:
    ...
    report = (
        "<b>📊 ОТЧЁТ О РАССЫЛКЕ «БИБЛИОТЕКА»</b>\n"
