...
export default function AdminPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#FDFCFA] via-[#FBF8F3] to-[#F5EFE6] dark:from-[#121212] dark:via-[#1A1A1A] dark:to-[#121212] flex items-center justify-center">
        <div className="text-center">
          ...
          />
          <p className="text-[#8B8279] dark:text-[#707070]">Загрузка...</p>
        </div>
      </div>
    )
  }
  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#FDFCFA] via-[#FBF8F3] to-[#F5EFE6] dark:from-[#121212] dark:via-[#1A1A1A] dark:to-[#121212] flex items-center justify-center p-4">
        <div className="bg-white/80 dark:bg-[#1E1E1E]/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-[#E8D4BA]/30 dark:border-[#3D3D3D] text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-[#5D4E3A] dark:text-[#E5E5E5] mb-3">Доступ запрещён</h1>
          <p className="text-[#8B8279] dark:text-[#707070] mb-6">
