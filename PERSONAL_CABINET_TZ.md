...
| 2 | Страница профиля | 3-4 дня | 🔄 UI готов |
...
| # | Задача | Статус |
|---|--------|--------|
| 2.1 | Создать `ProfilePage.tsx` — основной layout | ✅ Premium UI |
| 2.2 | Компонент `ProfileHeader` — аватар, имя, статус | ✅ в page.tsx |
| 2.3 | Компонент `SubscriptionCard` — статус подписки | ✅ базовый |
